...
export const EditStudent = ({ isUpdating = false }) => {
      ...
      >
        ...
        <Form.Item
          ...
          rules={[
            {
              required: true,
              message: "Please input parents Name!",
            },
          ]}
        >
        ...
        <Form.Item
          name="email"
          label="Other fields to be added"
          rules={[
            {
              type: "email",
        ...
        >
          <Input placeholder="Other fields to be added" autoComplete="new-password" />
        </Form.Item>
