...
export const PendingTable = () => {
  ...
  const handleAddCompany = () => {
    navigate("?module=pending&view=new");
  };
            ...
            {!isBlocked && (
              ...
              <div style={{display:'flex',justifyContent:'space-between'}}>
                ...
                <Tooltip title="Edit"style={{display:'flex',justifyContent:'space-between'}}>
                  <EditOutlined onClick={handleAddCompany} />
                </Tooltip>
  ...
  return (
    <Companies>
      <TableHeader>
        <div className="title">Upload the Certificates for Verification</div>
        {/* <div className="actions">
          <Button onClick={handleAddCompany}>
            <UserAddOutlined /> Filter
          </Button>
        </div> */}
      </TableHeader>
      <Table
